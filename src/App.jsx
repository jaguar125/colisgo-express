...
/* ---------- Landing page ---------- */
.landing{
  min-height:100vh; min-height:100dvh; background:var(--paper); display:flex; justify-content:center;
}
      ...
      <div className="cge">
        ...
        <div className="loading-screen">
          <div className="loading-mark">
            <Package color="#241300" size={30} />
          </div>
          <h1 className="loading-title">ColisGo‑Express</h1>
          <div className="loading-bar">
            <div className="loading-bar-fill" />
          </div>
          <p className="loading-caption">Préparation de votre marketplace…</p>
        </div>
      </div>
    );
  }
